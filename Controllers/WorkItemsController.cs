...
namespace GestaoDemandas.Controllers
{
    public class WorkItemsController : Controller
    {
        ...
        static WorkItemsController()
        {
            ...
            var pat = "3icjlaewk56pj3v2d6z5ssarsfjwojd2uy54mupc4mavje2ijewq"; // Replace with your PAT - Data da Expiração: 31/12/2024
